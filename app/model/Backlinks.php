...
class Backlinks
{
    ...
    public function getSaveBLDataFor($blID)
    {

        $this->db->where('backlinkID', $blID);
        $this->modelData['backlinkData'] = $this->db->getOne('backlinks');
    ...
    private function getCompetitorIDasString()
    {
    ...
    public function getBacklinks()
    {
        ...
        //$this->db->where('b.backlinkProject', $this->getCompetitorIDasString(), 'IN');
